...
dict_SAA_to_RPG = list("01 - Blé tendre d'hiver et épeautre" = c("BTH", "BH"),
                       ...
                       "15 - Maïs grain non irrigué" = c("MA", "MIS")
                         )
dict_RPG_to_SAA = list("BTH" = "01 - Blé tendre d'hiver et épeautre", 
                       "BH" = "01 - Blé tendre d'hiver et épeautre",
                       "MA" = c("14 - Maïs grain irrigué", "15 - Maïs grain non irrigué"),
                       "MIS" = c("14 - Maïs grain irrigué", "15 - Maïs grain non irrigué")
                       )
```
...
merge <- function(list_annee, list_cult, list_dept, list_region, list_var_clim, verbose=FALSE) {
  ...
  Mean_surface_parcelles = array_mean_surface,
  Median_surface_parcelles = array_median_surface,
  Variance_surface_parcelles = array_var_surface
  )
